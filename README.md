...
Goood afternoon, the dependencies used on this project are the following:
-Material-ui/core
-Material-ui/icons (for some icons)
-React-Redux

For some other icons i also used a script tag linked to 'boxIcons', those icons are:
-delete
-share
-exit

All the other buttons, inputs, modals on this project are crafted in CSS.

I separated the layouts from the components and modals by folder and used Redux for handling states.

Hope to exceed your expectations, best wishes.
